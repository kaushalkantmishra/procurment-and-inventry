...
export class ItemService {
  ...
  async createItem(itemData: any) {
    ...
    if (itemData.reorder_level)
      itemData.reorder_level = parseInt(itemData.reorder_level);
    if (itemData.safety_stock)
      itemData.safety_stock = parseInt(itemData.safety_stock);
    if (itemData.lead_time_days)
      itemData.lead_time_days = parseInt(itemData.lead_time_days);
