...
export class VendorController {
  ...
  getById = async (req: Request, res: Response) => {
    try {
      const vendor = await this.vendorService.getVendorById(parseInt(req.params.id));
  ...
  update = async (req: Request, res: Response) => {
    try {
      const vendor = await this.vendorService.updateVendor(parseInt(req.params.id), req.body);
  ...
  delete = async (req: Request, res: Response) => {
    try {
      const vendor = await this.vendorService.deleteVendor(parseInt(req.params.id));
