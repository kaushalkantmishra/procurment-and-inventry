        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <Package className="text-primary-600 dark:text-primary-400 mr-3" size={32} />
              <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">ERP Desk</h1>
            </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400">Sign in to your ERP Desk account</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg text-xs">
                <p className="mb-1"><strong>Admin:</strong> admin@company.com / admin123</p>
      ...
      <div className="flex-1 flex items-center justify-center p-8 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center text-gray-900 dark:text-gray-100 max-w-lg">
          <div className="inline-flex items-center justify-center w-24 h-24 bg-primary-100 dark:bg-primary-900/30 rounded-3xl shadow-2xl mb-8">
            <Package className="text-primary-600 dark:text-primary-400" size={48} />
          </div>

          <h1 className="text-5xl font-bold mb-4">ERP Desk</h1>
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
            Complete Procurement & Inventory Management System
          </p>

          <div className="grid grid-cols-2 gap-6 text-center">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-200 dark:border-gray-700">
              <div className="text-2xl font-bold mb-1">📦</div>
              <div className="text-sm font-medium text-gray-700 dark:text-gray-300">Inventory Control</div>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-200 dark:border-gray-700">
              <div className="text-2xl font-bold mb-1">🛒</div>
              <div className="text-sm font-medium text-gray-700 dark:text-gray-300">Procurement</div>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-200 dark:border-gray-700">
              <div className="text-2xl font-bold mb-1">📊</div>
              <div className="text-sm font-medium text-gray-700 dark:text-gray-300">Analytics</div>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-12">
            <p className="text-sm text-gray-500 dark:text-gray-400">
              © 2024 ERP Desk. All rights reserved.
            </p>
            <div className="text-sm text-gray-500 dark:text-gray-400">
              Version 1.0.0
            </div>
